...
# df['date'] = pd.to_datetime(df["yyyy"] + "-" + df["mm"] + "-" + df["dd"]).astype(object)
# df[['dd', 'mm', 'yyyy', 'hour', 'minutes']] = df[['dd', 'mm', 'yyyy', 'hour', 'minutes']].astype('int64')
# Create traces
# graph 1
...
# switch = html.Div(
#     [
#         dbc.Button("Date Based", color="warning", href="/factors_date"),
#     ],
#     style={
#         "marginLeft": '50px'
#     }
...
#     ]
# )
# rangeBased = dbc.Row([dbc.Col(datePick, width=4), dbc.Col(
#     topic, width=6), dbc.Col(switch, width=2)])
# ###########################  RANGE BASED END ############################
